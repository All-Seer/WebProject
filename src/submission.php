...
<head>
  ...
  <md-dialog id="autoCloseDialog">
    ...
    <div slot="headline" class="containerImg">
      <img src="/check.gif" class="dialogImg" alt="Success">
    </div>
  ...
  <div class="parentContainer">
    ...
    <div class="middleContainer">
      <form id="studentForm" method="POST">
        <md-outlined-text-field label="Personal Email" placeholder="user@gmail.com" type="email" name="personalEmail"
          required>
        ...
        <md-outlined-text-field label="Student ID" placeholder="0000-0000-000000" type="text" name="studentID" required>
        </md-outlined-text-field>

        <md-outlined-text-field label="First Name" placeholder="Christian Jeano" type="text" name="firstName" required>
        </md-outlined-text-field>
